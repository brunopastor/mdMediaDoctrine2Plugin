...
class sfWidgetFormInputSWFUpload extends sfWidgetFormInputFile
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('debug', $this->options_data['widget']['debug']);


    $this->addOption('swfupload_flash_url',     public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/js/vendor/swfupload/swfupload/swfupload.swf'));

    $this->addOption('swfupload_css_path',      public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/css/swfupload.css'));
    $this->addOption('swfupload_js_path',       public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/js/vendor/swfupload/swfupload/swfupload.js'));
    $this->addOption('swfupload_progress_path', public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/js/swfupload-progressFile.js'));
    $this->addOption('swfupload_handler_path',  public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/js/swfupload-widget-handler.js'));
    $this->addOption('swfupload_plugins_dir',   public_path('/mdMediaDoctrine2Plugin/sfSWFUpload/theme_custom/js/vendor/swfupload/plugins'));
    $this->addOption('swfupload_button_image_url', null);
    
    $this->addOption('swfupload_button_width', 60);
    $this->addOption('swfupload_button_height', 24);
    ...
    //$this->addOption('swfupload_get_browse_button_element', '<a class="button" href="#">Upload</a>');    
  ...
  public function __construct($options = array(), $attributes = array(), $options_data = array()){
      $this->options_data = array_merge($this->options_data, $options_data);
