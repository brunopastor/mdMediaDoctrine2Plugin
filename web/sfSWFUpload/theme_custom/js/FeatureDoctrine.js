var Feature = (function()
  {
    ...
    function setOnBlur(f){
      onBlur = f;
    }

    function getLinkAlbum(){
      return _linkAlbum;
    }
    ...
    function addFileParam(file_id, name, value){
      swfUpload.addFileParam(file_id, name, value);
    }

    function removeFileParam(file_id, name){
      swfUpload.removeFileParam(file_id, name);
    }
